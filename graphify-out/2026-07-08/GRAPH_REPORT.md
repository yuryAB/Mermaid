...
## Corpus Check
- 267 files · ~678,497 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3918 nodes · 14172 edges · 229 communities (140 shown, 89 thin omitted)
...
## Communities (229 total, 89 thin omitted)

### Community 0 - "Map Tiles — Mossy Terrain"
Cohesion: 0.09
Nodes (83): SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r04 c09, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r04 c10, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r04 c11, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r04 c12, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r04 c13, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r04 c14, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r05 c01, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r05 c02 (+75 more)

### Community 1 - "Mermaid House System"
Cohesion: 0.18
Nodes (5): HouseBuildPanel, MermaidHouseSceneController, ObjectIdentifier, Set, UITouch

### Community 2 - "Map Tiles — Mossy Autotile"
Cohesion: 0.09
Nodes (84): SharedGameData → Tiles → Mossy → terrain 256 → autotile preview, SharedGameData → Tiles → Mossy → terrain 256 → contact sheet, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain auto e 01, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain auto e 02, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain auto e 03, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain auto e 04, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain auto ew 01, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain auto ew 02 (+76 more)

### Community 3 - "Gameplay Models & Scene Construction"
Cohesion: 0.07
Nodes (17): SKShapeNode, CGSize, GameUI, CGRect, NSCache, NSString, SKSpriteNode, SKTexture (+9 more)

### Community 4 - "Challenge Flow Controller"
Cohesion: 0.09
Nodes (4): GameScene, Bool, SKCameraNode, SKView

### Community 5 - "World Point & Rendering Primitives"
Cohesion: 0.09
Nodes (18): CGLineCap, SKShapeNode, SKTexture, TimeInterval, UIBezierPath, UIColor, UIImage, WorldPOIArtworkFactory (+10 more)

### Community 6 - "Depth Environment & Ocean Parallax"
Cohesion: 0.12
Nodes (8): SKNode, NSCoder, SupportResourceVisualFactory, UIColor, AmbientLifeNode, TimeInterval, UIColor, SKBlendMode
...
Cohesion: 0.10
Nodes (7): CGPoint, RefugeArtDirection, RefugeVillageController, CGRect, Mermaid, TimeInterval, UIColor
...
Cohesion: 0.12
Nodes (63): SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c08, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c09, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c10, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c11, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c12, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c13, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r10 c14, SharedGameData → Tiles → Mossy → terrain 256 → mossy terrain r11 c01 (+55 more)

### Community 14 - "Shell Snap Minigame"
Cohesion: 0.13
Nodes (10): ShellSnapOverlay, ShellSnapRules, ShellSnapTheme, Bool, NSCoder, SKLabelNode, UIColor, UIEvent (+2 more)
...
Cohesion: 0.05
Nodes (30): RewardSystem, challengeHighScores, inventoryItems, regionProgress, repeatablePOIRewardAvailableAtByKey, MermaidEmotionalState, MermaidMoodCue, currentLift (+22 more)

### Community 17 - "Resource Support & Shop"
Cohesion: 0.06
Nodes (39): Calendar, RefugeScene, SKView, TimeInterval, RefugeShopCatalog, RefugeShopItem, RefugeShopPurchase, resource (+31 more)

### Community 18 - "Entity Components — Visual Effects"
Cohesion: 0.08
Nodes (26): ExpressionComponent, NSCoder, HealthComponent, NSCoder, IntentComponent, NSCoder, LifetimeComponent, Bool (+18 more)
...
Cohesion: 0.12
Nodes (8): ChallengeRewardProfile, ChallengeVictoryReward, none, resource, shellBonus, GameBalance, Bool, ClosedRange

### Community 21 - "Mermaid Stats — Balance & Buffs"
Cohesion: 0.05
Nodes (43): CodingKeys, activeBuffs, adaptationByZone, babyGuaranteedRequestsUsed, balanceVersion, birthDate, collectedPOIRewardKeys, courage (+35 more)
...
Cohesion: 0.11
Nodes (15): GridPos, Bool, NSCoder, Set, UIEvent, UITouch, Void, TideSessionType (+7 more)
...
Cohesion: 0.17
Nodes (10): SKAction, TimeInterval, MermaidArms, Orientation, horizontal, vertical, Rotation, down (+2 more)

### Community 27 - "Challenge Giver Component"
Cohesion: 0.16
Nodes (12): ChallengeKind, ascent, banquet, echoMelody, memory, plot, reefAsteroids, snap (+4 more)

### Community 28 - "Autonomy — Fish Play & Guidance"
Cohesion: 0.11
Nodes (8): FishNode, Bool, NSCoder, TimeInterval, UIColor, FishSystem, Bool, CGFloat
...
Cohesion: 0.08
Nodes (26): ReefAsteroidsEngine, ReefAsteroidsRules, ReefFeedback, ReefFeedbackEffect, combo, crack, hit, score (+18 more)

### Community 31 - "Region System"
Cohesion: 0.05
Nodes (40): CaseIterable, Codable, InteractionBalance, POIChallenge, POIDefinition, POISystem, POIVisual, RepeatablePOIReward (+32 more)

### Community 32 - "Reef Asteroids Overlay"
Cohesion: 0.09
Nodes (11): ReefAsteroidsOverlay, Bool, Mermaid, NSCoder, Set, SKLabelNode, SKShapeNode, UIColor (+3 more)
...
Cohesion: 0.08
Nodes (21): Encoder, Reward, RewardKind, item, pearls, regionMap, story, supportResource (+13 more)
...
Cohesion: 0.17
Nodes (10): ChallengeFlowController, Bool, SKCameraNode, Void, ChallengeChoiceOverlay, ChallengeResult, POIChallengeOfferOverlay, Void (+2 more)
...
Cohesion: 0.18
Nodes (9): ReefCluster, CGRect, SKSpriteNode, WorldChunkFactory, NSCache, NSString, SKTexture, WorldTextureCache (+1 more)
...
Cohesion: 0.14
Nodes (8): BanquetOfTidesOverlay, Bool, Mermaid, NSCoder, SKLabelNode, SKShapeNode, UIColor, Void

### Community 45 - "Autonomy — Eating Behavior"
Cohesion: 0.10
Nodes (5): AutonomySystem, play, Bool, Mermaid, CGVector

### Community 46 - "Cheat System"
Cohesion: 0.10
Nodes (13): Comparable, CheatSystem, Suggestion, Bool, ClosedRange, Set, MermaidPhase, adult (+5 more)

### Community 47 - "Fish Visual Models"
Cohesion: 0.07
Nodes (39): FishDrawingFactory, Bool, SKShapeNode, UIBezierPath, UIColor, FishPattern, glowDots, plain (+31 more)

### Community 48 - "Food System"
Cohesion: 0.14
Nodes (10): FoodComponent, Bool, NSCoder, FoodKind, FoodNode, FoodSystem, Bool, NSCoder (+2 more)
...
Cohesion: 0.17
Nodes (14): BuildRejection, leftOfEntrance, notAdjacent, occupied, HouseGridPosition, HouseLayoutData, HouseMVPPolicy, HouseRoom (+6 more)

### Community 52 - "HUD Layer"
Cohesion: 0.06
Nodes (37): BondRecoveryHUDState, available, hidden, ready, waiting, PlayerCommand, challenge, explore (+29 more)

### Community 53 - "Expedition Grid Math"
Cohesion: 0.15
Nodes (7): expeditionRevealByRegion, Bool, ExpeditionMapNode, Region, NSCoder, SKShapeNode, UIColor

### Community 54 - "World Stamp Drawing"
Cohesion: 0.13
Nodes (12): Channel, caustics, fog, particles, shader, OceanPalette, OceanVisualTuning, Style (+4 more)

### Community 55 - "Pearl Economy"
Cohesion: 0.19
Nodes (5): ChallengeChrome, Bool, NSCoder, SKLabelNode, UIColor

### Community 56 - "HUD — Biology Meter & Commands"
Cohesion: 0.17
Nodes (12): CGPath, HouseBuildSlotNode, Kind, blocked, valid, CGRect, NSCoder, SKLabelNode (+4 more)
...
Cohesion: 0.11
Nodes (19): MermaidExpressionPreset, MermaidEyeAsset, closed, half, open, wide, MermaidEyebrowExpression, MermaidFacePose (+11 more)

### Community 62 - "Command & Touch System"
Cohesion: 0.25
Nodes (9): ShellSnapBoard, ShellSnapFall, ShellSnapPop, ShellSnapPosition, ShellSnapSpawn, ShellSnapTile, Double, Set (+1 more)

### Community 63 - "Mermaid Rig Debug Tool"
Cohesion: 0.14
Nodes (12): MermaidFigurePart, MermaidRigDebugTool, PreviewFit, Bool, MermaidFigurePart, NSCoder, Set, SKLabelNode (+4 more)
...
Cohesion: 0.16
Nodes (12): HouseRoomNode, HouseSurface, HouseSurfaceKind, backWall, ceiling, leftWall, rightWall, RoomSurfaceMapper (+4 more)

### Community 67 - "Autonomy — Bond Recovery"
Cohesion: 0.10
Nodes (18): BondRecoveryBalance, BondRecoveryState, idle, ready, waiting, FishCompanionAction, guide, FishPlayBalance (+10 more)
...
Cohesion: 0.21
Nodes (9): Int, floor, Hasher, Identifiable, AutotileSet, Bool, Set, TerrainCell (+1 more)
...
Cohesion: 0.12
Nodes (14): Bool, AquaticBiome, abyssPlain, ancientRuins, cavernMouth, coralGarden, crystalField, deepVents (+6 more)
...
Cohesion: 0.11
Nodes (22): App, AppKit, AutotileSummary, DepthRow, EditorToolbar, GridLines, MapCanvasView, PathSummary (+14 more)

### Community 75 - "Map Editor — Depth Save"
Cohesion: 0.10
Nodes (17): Decodable, ContentView, Bool, Set, Color, DepthDefinition, EditorDataLocation, EditorLayer (+9 more)
...
Cohesion: 0.33
Nodes (3): HouseGridMetrics, HouseMermaidAutonomyController, Mermaid
...
Cohesion: 0.08
Nodes (11): CoreText, World, UIColor, HousePhysicsCategory, WorldStampRenderer, WorldStampRenderer, SKTexture, Foundation (+3 more)
...
Cohesion: 0.10
Nodes (8): MermaidFace, SKSpriteNode, MermaidMouth, SKSpriteNode, MermaidHead, SKSpriteNode, MovementDirectionProtocol, MovementTypeProtocol

### Community 84 - "Ester Game"
Cohesion: 0.29
Nodes (3): AnyObject, ChallengeGiver, ChallengeSystem
...
Cohesion: 0.12
Nodes (16): MermaidExpressionLibrary, MermaidExpressionName, adventurous, curious, eating, focused, happy, hungry (+8 more)
...
Cohesion: 0.13
Nodes (14): HUDTypography, String, AquaticSpecies, AquaticSpeciesCatalog, EntryTextCatalog, AquaticAnimalGroup, RegistroCatalog, RegistroMermaidObservationDefinition (+6 more)
...
Cohesion: 0.16
Nodes (10): ChildMermaidRig, MermaidFigurePart, MermaidRigPosition, MermaidRigAxis, scale, x, y, z (+2 more)
...
Cohesion: 0.40
Nodes (5): POIState, active, completed, dormant, interacting
...
Cohesion: 0.33
Nodes (4): ChallengeGiverComponent, Bool, NSCoder, ChallengeGoalRange
...
- **Why does `CGFloat` connect `Autonomy — Fish Play & Guidance` to `Mermaid House System`, `Gameplay Models & Scene Construction`, `Challenge Flow Controller`, `World Point & Rendering Primitives`, `Depth Environment & Ocean Parallax`, `Banquet of Tides Minigame`, `Event System`, `Species Registry & Mermaid Progression`, `Tide Memory Minigame`, `Refuge Village Controller`, `Shelter System`, `Shell Snap Minigame`, `Echo Melody Minigame`, `Mermaid Stats & Inventory`, `Resource Support & Shop`, `Entity Components — Visual Effects`, `Challenge Goals & Spawning`, `Bubble Climb Controls`, `Tide Weaving System`, `World Stamp Rendering`, `Mermaid Arms & Animation`, `Mermaid Figures — Baby`, `Reef Asteroids Minigame Engine`, `Region System`, `Reef Asteroids Overlay`, `Depth System`, `Gameplay Reward Models`, `Ecosystem Biome Catalog`, `POI System`, `Growth System`, `Mermaid Figures — Child`, `World Chunk — Detail Rendering`, `Movement Vector Utilities`, `Autonomy — Eating Behavior`, `Cheat System`, `Fish Visual Models`, `Food System`, `Region Map Cues & Expedition`, `Movement Enums & Animation Modes`, `HUD Layer`, `Expedition Grid Math`, `World Stamp Drawing`, `Pearl Economy`, `HUD — Biology Meter & Commands`, `Mermaid Name Editor`, `Discovery & Depth Ranges`, `Depth Zone Colors`, `Mermaid Emotion Component`, `Mermaid Rig Debug Tool`, `Mermaid Core Entity`, `Encoding Utilities`, `Autonomy — Bond Recovery`, `Mermaid Intent & Acceptance`, `Autotile Set Hashing`, `Mermaid Rig Models`, `Aquatic Biomes`, `Map Editor — SwiftUI Content View`, `Refuge Entry & Energy`, `Ester Game`, `Components`, `Managers`, `Ester Game`, `Components`, `Ester Game`, `Components`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`?**
  _High betweenness centrality (0.239) - this node is a cross-community bridge._
- **Why does `String` connect `Ester Game` to `Mermaid House System`, `Gameplay Models & Scene Construction`, `Challenge Flow Controller`, `World Point & Rendering Primitives`, `Depth Environment & Ocean Parallax`, `Banquet of Tides Minigame`, `Event System`, `Species Registry & Mermaid Progression`, `Tide Memory Minigame`, `Refuge Village Controller`, `Shelter System`, `Shell Snap Minigame`, `Echo Melody Minigame`, `Mermaid Stats & Inventory`, `Resource Support & Shop`, `Entity Components — Visual Effects`, `Game Scene Entries & Birth Waters`, `Challenge Goals & Spawning`, `Mermaid Stats — Balance & Buffs`, `Audio Manager & Sound Effects`, `Bubble Climb Controls`, `Tide Weaving System`, `Challenge Giver Component`, `Reef Asteroids Minigame Engine`, `Region System`, `Reef Asteroids Overlay`, `Depth System`, `Gameplay Reward Models`, `Ecosystem Biome Catalog`, `POI System`, `Growth System`, `World Chunk — Detail Rendering`, `Movement Vector Utilities`, `Autonomy — Eating Behavior`, `Cheat System`, `Fish Visual Models`, `Food System`, `Region Map Cues & Expedition`, `Fish Drawing Factory`, `HUD Layer`, `Expedition Grid Math`, `World Stamp Drawing`, `Pearl Economy`, `Buff Coding Keys`, `Mermaid Name Editor`, `Discovery & Depth Ranges`, `Depth Zone Colors`, `Mermaid Emotion Component`, `Mermaid Rig Debug Tool`, `Mermaid Core Entity`, `Encoding Utilities`, `Mermaid Intent & Acceptance`, `Autotile Set Hashing`, `Mermaid Rig Models`, `Aquatic Biomes`, `Mermaid Figure Part Positioning`, `Map Editor — SwiftUI Content View`, `Map Editor — Depth Save`, `Ester Game`, `Components`, `Ester Game`, `Managers`, `Managers`, `Managers`, `Components`, `Ester Game`, `Ester Game`, `Ester Game`, `Components`, `Ester Game`, `Managers`, `Ester Game`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `CGPoint` connect `Refuge Village Controller` to `Mermaid House System`, `Gameplay Models & Scene Construction`, `Challenge Flow Controller`, `World Point & Rendering Primitives`, `Depth Environment & Ocean Parallax`, `Banquet of Tides Minigame`, `Event System`, `Species Registry & Mermaid Progression`, `Tide Memory Minigame`, `Shelter System`, `Shell Snap Minigame`, `Echo Melody Minigame`, `Mermaid Stats & Inventory`, `Entity Components — Visual Effects`, `Challenge Goals & Spawning`, `Bubble Climb Controls`, `Tide Weaving System`, `World Stamp Rendering`, `Mermaid Arms & Animation`, `Autonomy — Fish Play & Guidance`, `Mermaid Figures — Baby`, `Reef Asteroids Minigame Engine`, `Region System`, `Reef Asteroids Overlay`, `POI System`, `Growth System`, `Mermaid Figures — Child`, `World Chunk — Detail Rendering`, `Movement Vector Utilities`, `Autonomy — Eating Behavior`, `Fish Visual Models`, `Food System`, `Region Map Cues & Expedition`, `Movement Enums & Animation Modes`, `HUD Layer`, `Expedition Grid Math`, `Pearl Economy`, `HUD — Biology Meter & Commands`, `Discovery & Depth Ranges`, `Depth Zone Colors`, `Mermaid Emotion Component`, `Mermaid Rig Debug Tool`, `Game Sound Enum Values`, `Autotile Set Hashing`, `Aquatic Biomes`, `Mermaid Figure Part Positioning`, `Map Editor — SwiftUI Content View`, `Refuge Entry & Energy`, `Ester Game`, `Managers`, `Ester Game`, `Components`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Ester Game`, `Managers`, `Ester Game`, `Ester Game`?**
